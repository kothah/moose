...
template <>
InputParameters
validParams<HardikGaussContForcing>(){
    InputParameters params = validParams<Kernel>();
    params.addParam<Real>("amplitude", 1.0, "Amplitude of the bell curve");
...
HardikGaussContForcing::HardikGaussContForcing(const InputParameters & parameters)
: Kernel (parameters),
...
Real HardikGaussContForcing::computeQpResidual(){
