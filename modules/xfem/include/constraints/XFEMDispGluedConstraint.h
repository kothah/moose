...
#ifndef XFEMDISPGLUEDCONSTRAINT_H
#define XFEMDISPGLUEDCONSTRAINT_H
...
class XFEMDispGluedConstraint;
class XFEM;

template <>
InputParameters validParams<XFEMDispGluedConstraint>();

class XFEMDispGluedConstraint : public ElemElemConstraint
{
public:
  XFEMDispGluedConstraint(const InputParameters & parameters);
  virtual ~XFEMDispGluedConstraint();
...
#endif /* XFEMDISPGLUEDCONSTRAINT_H_ */
